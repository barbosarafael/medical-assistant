...
- Fontes: ANVISA, CFM, Ministério da Saúde.

### 2. **Burocracia e Codificação**
> Correlação entre tabelas médicas e classificações nacionais.
- Ex: “Qual é o código TUSS de uma tomografia de tórax?”
- Fontes: TUSS, SIGTAP, CID-10, CBHPM.

### 3. **Gestão e Auditoria**
> Processos de auditoria, faturamento e interoperabilidade.
- Ex: “O que é uma AIH e como é usada no SIA/SUS?”
- Fontes: TISS, CNES, SIA/SUS.

### 4. **Pesquisa e Ensino**
> Apoio ao estudo e compreensão de estruturas do sistema de saúde.
- Ex: “Explique a diferença entre vigilância sanitária e epidemiológica.”
- Fontes: OMS, e-SUS AB, PNAD Saúde.
